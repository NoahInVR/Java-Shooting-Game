...
public class Game extends Thread {
    ...
    private Image player = new ImageIcon("src/images/player.jpg").getImage();
    ...
    private Audio loadingMusic;

    @Override
    public void run() {
        backgroundMusic = new Audio("src/audio/gameBGM.wav", true);
        hitSound = new Audio("src/audio/HIT_BGM.wav", false);
        loadingMusic = new Audio("src/audio/loading_BGM.wav", true);
